    ...
    try:
        ...
        routers = [
            ...
            (
                "v1_moon",
                v1_moon,
                ["current_moon_phase", "upcoming_moon_events", "moon_ritual"],
            ),
            (
                "v1_timing",
                v1_timing,
                [
                    "get_timing_advice_endpoint",
                    "find_best_days_endpoint",
            ...
            (
                ...
                v1_journal,
                [
                    "add_journal_entry_endpoint",
                    "record_outcome_endpoint",
                    "get_journal_readings",
                    "get_single_reading_journal",
                    "get_journal_stats",
            ...
            (
                ...
                [
                    ...
                    "get_relationship_timing",
                    "get_best_days_for_love",
            ...
            (
                "v1_numerology",
                v1_numerology,
                ["numerology_from_payload", "numerology_profile"],
            ),
        ...
        for router_name, router_module, expected_functions in routers:
            ...
            route_count = len(
                [r for r in router_module.router.routes if hasattr(r, "path")]
            )
            total_routers += 1
            ...
            print(
                f"{status} {router_name:25} {route_count:3} routes    {len(expected_functions)} expected functions"
            )
            if missing:
