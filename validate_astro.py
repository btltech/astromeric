...
print(f"Location: New York, NY ({test_data['profile']['latitude']}, {test_data['profile']['longitude']})")
print()
...
if sun.get('degree', 0) < 20 or sun.get('degree', 0) > 28:
    issues.append(f"⚠️  Sun degree unusual: {sun.get('degree', 0):.2f}° (expected ~23-25°)")
