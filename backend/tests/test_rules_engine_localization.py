...
from app.engine.charts.models import Aspect, PlanetPosition
from app.engine.rules.engine import Chart, RuleEngine
...
class TestRulesEngineLocalization:
    ...
    def test_evaluate_localized(self, mock_get_meaning_block):
        ...
        chart.planets = [
            PlanetPosition(
                name="Sun", sign="Aries", degree=0, absolute_degree=0, house=1
            )
        ]
        chart.aspects = []

        engine.evaluate("general", chart, lang="es")
        ...
        for call in calls:
            ...
            if (
                args[1] == "Sun"
                and args[2] == "Aries"
                and kwargs.get("lang") == "es"
                and kwargs.get("context") == "planet_sign"
            ):
                found_sign = True
                break
        assert found_sign
        ...
        for call in calls:
            ...
            if (
                ...
                and args[2] == 1
                and kwargs.get("lang") == "es"
                and kwargs.get("context") == "planet_house"
            ):
                found_house = True
                break
        assert found_house
    ...
    def test_aspect_factors_localized(self, mock_get_meaning_block):
        ...
        engine._aspect_factors(aspects, "natal", lang="es")
    ...
    def test_numerology_factors_localized(self, mock_get_meaning_block):
        ...
        engine._numerology_factors(numerology, lang="es")
