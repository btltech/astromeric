...
from .astrology import get_zodiac_sign, get_element, ELEMENT_MAP
from .numerology import calculate_life_path_number
from .numerology_extended import (
    calculate_expression_number, calculate_soul_urge_number,
    get_number_meaning
)

# Element compatibility matrix
ELEMENT_COMPAT = {
    ("Fire", "Fire"): {"score": 80, "desc": "Passionate and dynamic, but watch for power struggles."},
    ("Fire", "Air"): {"score": 90, "desc": "Exciting combination! Air fans Fire's flames."},
    ("Fire", "Earth"): {"score": 50, "desc": "Different paces. Fire inspires, Earth grounds."},
    ("Fire", "Water"): {"score": 40, "desc": "Steam or sizzle? Emotional intensity ahead."},
    ("Air", "Air"): {"score": 75, "desc": "Intellectual connection, but may lack grounding."},
    ("Air", "Earth"): {"score": 55, "desc": "Head vs. heart. Needs patience and compromise."},
    ("Air", "Water"): {"score": 60, "desc": "Creative potential if emotions are honored."},
    ("Earth", "Earth"): {"score": 85, "desc": "Stable and reliable. Build something lasting."},
    ("Earth", "Water"): {"score": 90, "desc": "Nurturing and supportive. Natural harmony."},
    ("Water", "Water"): {"score": 80, "desc": "Deep emotional bond. Watch for overwhelm."},
}

# Life Path compatibility
LIFE_PATH_COMPAT = {
    (1, 1): {"harmony": 70, "friction": "Power struggles", "advice": "Take turns leading."},
    (1, 2): {"harmony": 85, "friction": "Independence vs. togetherness", "advice": "Balance autonomy with partnership."},
    (1, 3): {"harmony": 90, "friction": "Focus differences", "advice": "Combine leadership with creativity."},
    (1, 5): {"harmony": 95, "friction": "Restlessness", "advice": "Adventure together."},
    (2, 2): {"harmony": 85, "friction": "Over-sensitivity", "advice": "Communicate feelings openly."},
    (2, 6): {"harmony": 95, "friction": "Dependency", "advice": "Nurture each other equally."},
    (3, 3): {"harmony": 80, "friction": "Scattered energy", "advice": "Focus your creative powers."},
    (3, 5): {"harmony": 90, "friction": "Commitment fears", "advice": "Keep things exciting but stable."},
    (4, 4): {"harmony": 80, "friction": "Rigidity", "advice": "Allow flexibility in routines."},
    (4, 8): {"harmony": 95, "friction": "Workaholism", "advice": "Build empire, but make time for each other."},
    (5, 5): {"harmony": 85, "friction": "Lack of stability", "advice": "Create some grounding rituals."},
    (6, 6): {"harmony": 90, "friction": "Over-giving", "advice": "Remember self-care."},
    (7, 7): {"harmony": 85, "friction": "Isolation", "advice": "Share your inner worlds."},
    (8, 8): {"harmony": 80, "friction": "Competition", "advice": "Collaborate, don't compete."},
    (9, 9): {"harmony": 90, "friction": "Idealism", "advice": "Ground your visions in reality."},
}

RELATIONSHIP_TEXTS = {
    "romantic": {"frame": "romantic partnership", "focus": "love, intimacy, long-term potential"},
    "friend": {"frame": "friendship", "focus": "trust, fun, mutual support"},
    "family": {"frame": "family bond", "focus": "understanding, acceptance, shared history"},
    "business": {"frame": "business partnership", "focus": "collaboration, strengths, professional synergy"},
}
...
def get_element_compat(e1: str, e2: str) -> Dict:
    ...
    if key[0] == key[1]:
        key = (e1, e2)
    return ELEMENT_COMPAT.get(key, {"score": 65, "desc": "Unique combination with growth potential."})
...
def get_life_path_compat(lp1: int, lp2: int) -> Dict:
    ...
    default = {"harmony": 70, "friction": "Different approaches", "advice": "Appreciate your differences."}
...
def calculate_numerology_compatibility(name1: str, dob1: str, name2: str, dob2: str) -> Dict:
...
def calculate_combined_compatibility(
    ...
    rel_context = RELATIONSHIP_TEXTS.get(relationship_type, RELATIONSHIP_TEXTS["romantic"])
